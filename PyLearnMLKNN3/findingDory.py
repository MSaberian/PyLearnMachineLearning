...
class FindingDory:
    def __init__(self, train_image):
        self.light_orange = (90, 100, 20)
        self.dark_orange = (130, 255, 255)
        self.light_white = (20, 120, 150)
        self.dark_white = (30, 255, 255)
        self.light_black = (45, 0, 5)
        self.dark_black = (120, 255, 60)
        self.knn = KNN(k=3)
